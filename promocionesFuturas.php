...
<head>
  ...
  <title>Promociones futuras | Sistema de Inventario</title>
                ...
                while($dProm = mysqli_fetch_array($res)){
                    echo "<tr>";
                        ...
                        if($rol!=""){
                            ...
                            echo "<td>";
                        echo "<a class='btn btn-danger' onclick='return eliminaPromo()' href='eliminaPromo.php?p=2&id=".$dProm["id"]."' role='button'>Eliminar Promo</a>";
                        echo "</td>";
                        }
                    echo "</tr>";
                }
                    ...
                    echo "<p class='fs-4'>No hay promociones programadas para los siguientes dias</p>";
                }
            ?>
        </div>
    </div>
