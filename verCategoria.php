...
if(!isset($_GET['id'])){
    header("location:http://localhost/FDW21/proyecto/categorias.php");
}
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Categoria | Sistema de Inventario</title>
...
<div class="container-fluid">
    ...
    ?>
        <div class="col py-3">
            ...
            <?php
            $name = "select Nombre from categoria where idCategoria=".$_GET['id'];
            $dd = mysqli_query(conectDB(),$name);
            $nameF = mysqli_fetch_array($dd);
            echo "<h3>Categoria: ".$nameF['Nombre']."</h3>";
            ...
            productos.idFabricante=F.idFabricante inner join categoria as C on productos.idCategoria=C.idCategoria where C.idCategoria=".$_GET['id'];
