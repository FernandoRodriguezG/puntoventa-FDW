...
<head>
  ...
  <title>Promociones pasadas | Sistema de Inventario</title>
...
<div class="container-fluid">
    ...
    ?>
        <div class="col py-3">
            ...
            $cons = "select * from promociones where fechaFinal<'".date('Y-m-d')."'";// as P inner join categoria as C on p.id=C.idCategoria where p.fechaFinal>='".date('Y-m-d')."'";
            ...
            if(mysqli_num_rows($res)){
                ...
                if($rol!="")
                    echo "<th scope='col'></th>"; echo "<th scope='col'></th>";         
                echo "</tr>";
                echo "</thead>";
                while($dProm = mysqli_fetch_array($res)){
                    echo "<tr>";
                        ...
                        if($rol!=""){
                            ...
                            echo "<td>";
                        echo "<a class='btn btn-danger' onclick='return eliminaPromo()' href='eliminaPromo.php?p=3&id=".$dProm["id"]."' role='button'>Eliminar Promo</a>";
                        echo "</td>";
                        }
                    echo "</tr>";
                }
                    ...
                    echo "<p class='fs-4'>No hay resultados de promociones pasadas</p>";
                }
            ?>
        </div>
    </div>
